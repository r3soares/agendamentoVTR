...
class AgendaDoDiaAntigaWidget extends StatefulWidget {
  const AgendaDoDiaAntigaWidget({Key? key}) : super(key: key);

  @override
  _AgendaDoDiaAntigaWidgetState createState() => _AgendaDoDiaAntigaWidgetState();
}

class _AgendaDoDiaAntigaWidgetState extends ModularState<AgendaDoDiaAntigaWidget, AgendaAntigaStore> {
